...
def main():
    ...
    # Class separation visualization (PCA)
    plot_class_separation(X_test_scaled_final if config.FINAL_RETRAIN_ON_TRAIN_VAL else X_test_scaled,
        y_test, title="Separarea Claselor in Spatiul Caracteristicilor (PCA)",
        save_path=os.path.join(config.OUTPUT_DIR, "class_separation.png"))
